    ...
    <div>
      <section id="hero" className="hero"  style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/herobg.png)`, backgroundSize: "cover", backgroundPosition: "center", height: "99vh", display: "flex", alignItems: "center", justifyContent: "space-around" }}>
        <div className="container">
          <div className="row">
            <div className="bg col-lg-6 d-flex flex-column justify-content-center text-lg-start " style={{ marginTop: "50px" }}>
  ...
  >
    ...
    <span> Get Started</span>
            ...
            <div className="col-lg-6 hero-img">
              <img src="/images/BAg.png" className="img-fluid" alt="Old Books" style={{height: "400PX", width:'500PX', marginTop: "150px" }} />
            </div>
          </div>
        </div>
      </section>
